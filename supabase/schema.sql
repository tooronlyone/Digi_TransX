...
create table public.trusted_devices (
    ...
    constraint trusted_devices_token_digest_unique unique (token_digest),
    constraint trusted_devices_token_digest_shape check (octet_length(token_digest) = 32),
    constraint trusted_devices_previous_digest_shape check (
        previous_token_digest is null or octet_length(previous_token_digest) = 32
    ),
    constraint trusted_devices_timestamp_order check (
...
insert into public.canonical_event_catalog_projection (
    ...
    ('security.trusted_device.added', 1, 'security', 'security', 'security_12_months', 'planned', true, true),
    ('security.trusted_device.removed', 1, 'security', 'security', 'security_12_months', 'planned', true, true),
