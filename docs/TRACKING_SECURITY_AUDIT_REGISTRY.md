...
| `20260801220000_mpin_step_up_high_risk_integration.sql` | Adds exact wallet funding-source binding and activates consumption/reconciliation evidence for the six reviewed domain owners | Feature-branch only; immutable SHA-256 `0CA345DB3A3CF3DC0221B54FC0F0F34E3A5ED58A56CE6D75B8326F8C008F6C2E`; Git blob `ae38c8cd7962f32a341924fa7f4fc476dbab6292`; not applied to shared TEST or production. |
